...
const WorkZone = ({ collaborationCallbacks }: WorkZoneProps) => {
  ...
  const {
    ...
    draggedModuleId, setDraggedModuleId,
    hoveredLinkId, setHoveredLinkId,
    editingTabIndex, setEditingTabIndex,
    collapsedBlocks, setCollapsedBlocks,
    collapsedBlockSections, setCollapsedBlockSections,
  ...
  // Local wrapper for role selection (same signature as before)
